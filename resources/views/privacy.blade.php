    ...
    <!-- <section>
        <div class="container-fluid px-0 ">
          <div class="position-relative index_banner">
            ...
            <h5  class="text-white fs_50 fw_700 mt-5 ms-5"> Privacy Policey</h5>
            ...
            <nav aria-label="breadcrumb" class="ms-5">
                ...
                <li class="breadcrumb-item text-white fw-500 active" aria-current="page">Privacy Policy</li>
                </ol>
            </nav>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
            <h5  class=" fs_30 fw_500 mt-5 text-center "> Privacy Policey</h5>
