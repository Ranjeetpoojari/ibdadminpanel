      ...
      <section>
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="blog_card my-3">
                        <a href="blogdetail.html" target="_blank" class="blog_img">
                            <img src="{{url('/assets/images/filterpage.png}')}}" alt="" srcset="" class="w-100 h-100 p-2 rounded-2">
                        </a>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="blog_card my-3">
                        <a href="{{url('/assets/images/filterpage.png}')}}" target="_blank" class="blog_img">
                            <img src="img\innerimage.png" alt="" srcset="" class="w-100 h-100 p-2 rounded-2">
                        </a>
                        <div class="blog_content position-relative">
                            <span class="date position-absolute bg-prim text-white fw_500 fs_20 px-3 py-2 text-capitalize rounded-2 ms-4">22 jan</span>
                           <a href="{{url('/assets/images/filterpage.png}')}}" class="text-decoration-none"><h5 class="fw_500 fs_25 mt-4 ms-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. </h5></a> 
                            <p class="fw_400 fs_16 ms-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fugiat quasi ab excepturi nam accusamus, suscipit expedita repellat mollitia placeat odio.</p>
                        </div>
                    </div>
